-- Official listino names for the 9 bookable services.
-- Razor Taper / Skin Fade stay in the table but inactive (do not DELETE:
-- one cancelled appointment still references razor-taper).
...
-- Techniques ≠ services. Keep rows for historical snapshots; hide from any DB catalog read.
