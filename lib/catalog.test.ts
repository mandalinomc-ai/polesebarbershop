...
describe("catalog", () => {
  ...
  it("lists exactly the 10 official listino services with fixed operational durations", () => {
    ...
    expect(
      ...
      { id: "taglio-pro", name: "Taglio Pro", category: "capelli", priceEuro: 25, priceMaxEuro: null, durationMin: 30, durationKnown: true },
      ...
      { id: "taglio-bambino", name: "Taglio Bambino", category: "capelli", priceEuro: 12, priceMaxEuro: null, durationMin: 30, durationKnown: true },
  ...
  it("shows official ranges and Durata prevista labels (never n/d for the 10)", () => {
    ...
    expect(formatDuration(pro)).toBe("Durata prevista: 30 min");
    expect(formatDurationShort(pro)).toBe("30 min");
  ...
  it("sums multi-service durations including meches 150 and keeps variable price ranges", () => {
    ...
    expect(totals.durationMin).toBe(180);
    ...
    expect(totals.durationLabel).toBe("Durata prevista: 180 min");
  });

  it("sums Taglio Pro + Tintura Barba to 50 min", () => {
