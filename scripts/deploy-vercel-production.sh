...
echo "→ Deploying to production (felicepolesebarbershop.vercel.app)…"
vercel deploy --prebuilt --prod --token="$VERCEL_TOKEN"

echo "Done. Verify:"
echo "  https://felicepolesebarbershop.vercel.app"
echo "  https://felicepolesebarbershop.vercel.app/gestionale"
echo "  https://felicepolesebarbershop.vercel.app/#prenota"
